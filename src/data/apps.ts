...
export const APPS: SuiteApp[] = [
  {
    ...
    detail: localized(
      ...
      [
        'Atlas of Wisdom 是一個以 3D 地球儀為核心的互動地圖。預設會載入較為擬真的地球樣貌，需要網路連線——若沒有網路，可以在設定中切換為離線可用的樣式。探索橫跨不同傳統的精選地點，每個地點都有一段簡短、如說故事般的說明，解釋它為何重要，並附有時間軸與相關歷史人物的連結。',
  ...
  },
  {
    ...
    tagline: localized(
      'Life scenes shaped by the five auspicious beasts — a reading of your inner bearing',
